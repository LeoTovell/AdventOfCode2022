...
spaceUsed = dirSize["/"] # How much have we used in total?
totalSize = 70000000
minUnused = 30000000
maxUsed = totalSize - minUnused
extraSpaceNeeded = spaceUsed - maxUsed

candidates = []

for key, val in dirSize.items():
    if val >= extraSpaceNeeded:
        candidates.append(val)

print(min(candidates)) # Part 2